...
export default function ClickedItem0(props) {
            ...
            <div className='Clicked_product w-full flex flex-wrap justify-center font-custom-serif'>
                ...
                <div className="flex flex-col w-full md:w-1/3 items-start p-4 text-gray-700">
                    ...
                    <div className='mt-5 flex-col cursor-pointer w-full text-xl'>
                        ...
                        <ul className={`transition-all duration-300 text-gray-300 ease-in md:w-96 ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} space-y-0`}>
                        <p>Dive into a world of elegance, creating a canvas of captivating beauty. Here is a captivating design adorned with embroidery done with thread zari and sequins, this design is a visual feast for the eyes. Like a stroke of brilliance, As you drape yourself in this elegant ensemble, it reminds you of the beauty that lies within you, it comes with straight trousers and a chiffon dupatta.</p>
